...
BUILD		:=	build
SOURCES		:=	source source/system source/system/util source/system/draw source/youtube_parser source/youtube_parser/json11 source/scenes source/ui source/ui/views
DATA		:=	data
