...
public :
	...
	inline double button_y_pos() const { return y0 + DEFAULT_FONT_INTERVAL + (y1 - y0 - DEFAULT_FONT_INTERVAL) * 0.1; }
	inline double button_y_size() const { return (y1 - y0 - DEFAULT_FONT_INTERVAL) * 0.8; }
